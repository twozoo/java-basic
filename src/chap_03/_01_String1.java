...
public class _01_String1 {
    public static void main(String[] args) {
        ...
        System.out.println(s.indexOf("Java")); // 위치 정보 첫번재 글자 수는 0부터 시작이므로 7
        ...
        System.out.println(s.startsWith("I like")); // 이 문자로 시작하면 true / 아니면 false
        System.out.println(s.endsWith(".")); // 이 문자로 끝나면 true / 아니면 false
